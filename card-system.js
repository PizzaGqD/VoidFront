(function () {
  ...
  const ABILITY_DEFS = [
    ...
    { id: "shieldOvercharge", name: "Перегрузка Щитов", desc: "Полное восстановление щита города", cooldown: 120, icon: "🔋", cardRarity: "rare" },
    { id: "droneSwarm", name: "Рой Дронов", desc: "8 временных истребителей (30с)", cooldown: 90, icon: "🐝", cardRarity: "rare" },
    { id: "fakeSignature", name: "Ложная Сигнатура", desc: "Призрачный флот отвлекает врага 15с", cooldown: 80, icon: "👻", targeting: "point", cardRarity: "rare" },
    { id: "fleetBoost", name: "Ускорение Флота", desc: "+50% скорости всем юнитам 20с", cooldown: 70, icon: "⚡", cardRarity: "rare" },
    { id: "resourceSurge", name: "Ресурсный Всплеск", desc: "+3000 eCredits мгновенно", cooldown: 180, icon: "💎", cardRarity: "rare" },
    { id: "timeSingularity", name: "Сингулярность", desc: "Замедление врагов -60% в зоне 8с", cooldown: 110, icon: "⏳", targeting: "point", cardRarity: "epic" },
    { id: "orbitalStrike", name: "Орбитальный Удар", desc: "3 каскадных залпа по зоне: средний центр и малые вспомогательные удары", cooldown: 130, icon: "💥", targeting: "point", cardRarity: "legendary" },
    { id: "voidShield", name: "Щит Пустоты", desc: "Неуязвимость всех юнитов 3с", cooldown: 150, icon: "✨", cardRarity: "epic" },
    { id: "nanoSwarm", name: "Нанорой", desc: "10 урона + 2.5% от макс HP/с, -25% атаки врагов в зоне 20с", cooldown: 100, icon: "🦠", targeting: "point", cardRarity: "epic" },
    { id: "hyperJump", name: "Гиперскачок", desc: "Телепорт своих юнитов в точку", cooldown: 90, icon: "🚀", targeting: "point", cardRarity: "epic" },
    { id: "sabotage", name: "Диверсия", desc: "Уничтожает 20% eCredits ближайшего врага", cooldown: 120, icon: "💣", cardRarity: "rare" },
    { id: "emergencyRepair", name: "Аварийный Ремонт", desc: "Полное исцеление всех юнитов", cooldown: 180, icon: "🔧", cardRarity: "epic" },
    { id: "gravWave", name: "Грав. Волна", desc: "Отталкивает всех врагов от точки", cooldown: 80, icon: "🌊", targeting: "point", cardRarity: "rare" },
    { id: "resourceRaid", name: "Перехват Шахты", desc: "Захватывает вражескую шахту на 30с", cooldown: 150, icon: "⛏️", targeting: "point", cardRarity: "epic" },
    { id: "thermoNuke", name: "Термоядерный Импульс", desc: "Сверхтяжелая ракета летит к точке и уничтожает все корабли в огромном радиусе, полностью сбивая щит ядра.", cooldown: 200, icon: "☢️", targeting: "point", cardRarity: "legendary" }
  ];
